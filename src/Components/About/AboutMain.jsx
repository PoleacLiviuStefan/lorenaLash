...
const AboutMain = () => {
  ...
  return (
    <div name="DespreNoi" className='relative  text-white  shadow-xl'>
        ...
        <p className='mt-[2rem] lg:text-[20px] font-thin w-[80%] lg:w-[50rem] lg:text-justify'>Dragilor , ma numesc <span className='font-normal'>Lorena Danoiu</span> si activez in domeniul extensiile de gene de <span className='font-normal'>5 ani</span> , in prezent sunt trainer in cadrul propriei academii <span className='font-normal'> Lorena Lash Studio </span>.
