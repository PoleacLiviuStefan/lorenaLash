...
const CursEfecteSpeciale = () => {
  ...
  return (
    ...
    <div className=' lg:ml-[2rem] flex flex-col items-center w-[90%] lg:w-[25rem]'>           
        ...
        <button onClick={()=>{localStorage.setItem("cumparaCurs","Curs Efecte Speciale 1 Zi (Avans)"); navigate("/checkout");window.scrollTo({top:0,left:0})}} className='mt-[2rem] border-[2px] border-black w-full text-[18px]  h-[3rem] rounded-[8px] tracking-[6px] font-bold animate-[buyBtnReverse_.3s_ease-in-out_forwards] hover:animate-[buyBtn_.3s_ease-in-out_forwards]'>CUMPARA ACUM</button>
        ...
        <div className='relative lg:ml-[4rem] mt-[2rem] lg:mt-0 flex flex-col items-center w-[90%] lg:w-[40rem]'>
                ...
                <h2 className='text-[42px] font-oswald font-bold text-center'>Curs Foxy For a Day </h2>
