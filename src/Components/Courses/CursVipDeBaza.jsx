  ...
  return (
    <div className='flex justify-center items-center w-full h-full py-[5rem] lg:py-[10rem]'>
        ...
        <div className=' lg:ml-[2rem] flex flex-col items-center w-[90%] lg:w-[25rem]'>           
            <img src={cursVipDeBaza} className=" w-[21rem] lg:w-[25rem] h-[28rem]" />
            <button onClick={()=>{localStorage.setItem("cumparaCurs","Curs VIP De Baza");navigate("/checkout")}} className='mt-[2rem] border-[2px] border-black w-full text-[18px]  h-[3rem] rounded-[8px] tracking-[6px]'>CUMPARA ACUM</button>
