...
Iti doresti sa ai propria ta AFACERE si sa-ti urmezi visul in domeniul BEAUTY? Acum este momentul sa CREZI in tine si sa FACI primul pas catre o noua CARIERA! Ne vom asigura ca drumul tau in lumea extensiilor de gene va duce catre SUCCES"  redirectionare="curs-vip-de-baza" baza={false} />
          <CursMainPreview imagine={cursEfecteSpeciale} titlu="Curs Efecte Speciale " secondTitle="Avansati"  descriere="Acest curs este dedicat tehnicienilor cu experienta de minim 6 luni ce isi doresc sa treaca la urmatorul nivel si sa ofere cele mai ravnite efecte precum: Foxy, Eyeliner, Kim K, Wet, s.a. 
