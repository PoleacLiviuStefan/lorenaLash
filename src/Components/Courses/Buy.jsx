  ...
  useEffect(() => {
    switch (curs) {
        ...
        case "Curs VIP De Baza 2 Zile (Integral)":
          ...
          break;
        case "Curs VIP De Baza 3 Zile (Avans)":
        ...
        >
          ...
          <div className="flex flex-col my-[.5rem]">
              ...
              onChange={(e) => {
                ...
                setIndexSelectedCourse(
                  e.target.value === "Curs De Baza (Avans)"
                    ...
                    ? 0
                    : e.target.value === "Curs De Perfectionare 1 Zi (Avans)"
                    ? 1
                    : e.target.value === "Curs De Perfectionare 1 Zi (Integral)"
                    ? 1
                    ...
                    : e.target.value ===
                      "Curs VIP De Baza 2 Zile + Kit Inclus (Integral)"
                    ? -1
                    : e.target.value === "Curs VIP De Baza 3 Zile (Avans)"
                    ? -1
                    : e.target.value ===
                      "Curs VIP De Baza 3 Zile Fara Kit (Integral)"
                    ? -1
            ...
            >
              ...
              <option
                value="Curs De Perfectionare 1 Zi (Avans)"
                onClick={() => setCurs("Curs De Perfectionare 1 Zi (Avans)")}
                selected={
                  localStorage.getItem("cumparaCurs") ===
              ...
              <option
                value="Curs De Perfectionare 1 Zi (Integral)"
                onClick={() => setCurs("Curs De Perfectionare 1 Zi (Integral)")}
              >
                CURS DE PERFECTIONARE 1 ZI (INTEGRAL)
              </option>
              <option
                value="Curs De Perfectionare 2 Zile (Avans)"
                onClick={() => setCurs("Curs De Perfectionare 2 Zile (Avans)")}
              >
                CURS DE PERFECTIONARE 2 ZILE (AVANS)
              </option>
              <option
                value="Curs De Perfectionare 2 Zile (Integral)"
                onClick={() =>
                  setCurs("Curs De Perfectionare 2 Zile (Integral)")
                }
              >
                CURS DE PERFECTIONARE 2 ZILE (INTEGRAL)
              </option>
              ...
              <option
                value="Curs VIP De Baza 3 Zile (Avans)"
                onClick={() => setCurs("Curs VIP De Baza 3 Zile (Avans)")}
              >
                CURS VIP DE BAZA 3 ZILE (AVANS)
              </option>
              <option
