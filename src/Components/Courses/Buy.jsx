...
const Buy = () => {
    ...
    const [indexSelectedCourse,setIndexSelectedCourse]=useState(localStorage.getItem("cumparaCurs")==="Curs De Baza (Avans)" ? 0 :localStorage.getItem("cumparaCurs")==="Curs De Baza (Integral)" ? 0 : localStorage.getItem("cumparaCurs")=="Curs De Baza + Kit Inclus (Integral)" ? 0 : localStorage.getItem("cumparaCurs")==="Curs De Perfectionare 1 Zi (Avans)" ? 1 : localStorage.getItem("cumparaCurs")==="Curs De Perfectionare 1 Zi (Integral)" ? 1 : localStorage.getItem("cumparaCurs")==="Curs De Perfectionare 2 Zile (Avans)" ? 1 : localStorage.getItem("cumparaCurs")==="Curs De Perfectionare 2 Zile (Integral)" ? 1 : localStorage.getItem("cumparaCurs")==="Curs VIP De Baza 2 Zile (Avans)" ? -1 : localStorage.getItem("cumparaCurs")==="Curs VIP De Baza 2 Zile Fara Kit (Integral)"?  -1: localStorage.getItem("cumparaCurs")==="Curs VIP De Baza 2 Zile + Kit Inclus (Integral)"? -1: localStorage.getItem("cumparaCurs")==="Curs VIP De Baza 3 Zile (Avans)"? -1 : localStorage.getItem("cumparaCurs")==="Curs VIP De Baza 3 Zile Fara Kit (Integral)" ?-1: localStorage.getItem("cumparaCurs")==="Curs VIP De Baza 3 Zile + Kit Inclus (Integral)" ?-1 :localStorage.getItem("cumparaCurs")==="Curs Efecte Speciale 1 Zi (Avans)" ? 2 : 2)
    ...
    const perioadeCurs=[["21-22 Iulie", "10-11 August"],[""],[""]] 
      useEffect(()=>{
        ...
        {setPretCursSelectat("price_1NLYEpCV1XqGrlRbR2Rk6Pww")
